...
def _build_prompt(
    ...
    return (
        ...
        "  - Place at most 5 graphics total.\n"
        ...
        "  - Match the block type to what is being said (e.g. data-chart when numbers/stats mentioned).\n"
        "  - Fill `params` with relevant text values (title, label, name, etc.) drawn from the transcript.\n"
        "  - If no block is a good fit, return an empty array.\n\n"

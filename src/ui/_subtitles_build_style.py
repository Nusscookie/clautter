...
def build_provider_slot(parent: Any, w: dict) -> None:
    ...
    w["api_card"] = ctk.CTkFrame(_slot, fg_color=COLORS.BG_CARD, corner_radius=6)
    ...
    w["whisper_card"] = ctk.CTkFrame(_slot, fg_color=COLORS.BG_CARD, corner_radius=6)
    ...
    w["whisper_device_label"] = ctk.CTkLabel(whisper_row, text="CPU",
                                              ...
                                              text_color=COLORS.BRAND_PRIMARY, width=40, anchor="e")
...
def build_style_controls(parent: Any, w: dict) -> None:
    ...
    style_card = ctk.CTkFrame(parent, fg_color=COLORS.BG_CARD, corner_radius=6)
    ...
    w["wpl_label"] = ctk.CTkLabel(wpl_row, text="2",
                                   font=ctk.CTkFont(size=11), text_color=COLORS.BRAND_PRIMARY,
                                   width=24, anchor="e")
...
def build_text_style_card(parent: Any, w: dict) -> None:
    ...
    ts_card = ctk.CTkFrame(parent, fg_color=COLORS.BG_CARD, corner_radius=6)
    ...
    w["style_import_btn"] = ctk.CTkButton(
        ...
        border_width=1, border_color=COLORS.TEXT_SUBTLE,
    )
    w["style_import_btn"].grid(row=0, column=2)

    ctk.CTkFrame(ts_card, height=1, fg_color=COLORS.SEPARATOR, corner_radius=0).pack(
    ...
    ctk.CTkLabel(color_row, text="Text",
                 font=ctk.CTkFont(size=11), text_color=COLORS.TEXT_MUTED).pack(side="left", padx=(0, 4))
    w["text_color_btn"] = ctk.CTkButton(
        color_row, text="", width=36, height=26, corner_radius=4,
        fg_color="#FFFFFF", hover_color="#FFFFFF",
        border_width=2, border_color=COLORS.TEXT_SUBTLE,
    )
    w["text_color_btn"].pack(side="left", padx=(0, 16))

    w["outline_enabled_check"] = ctk.CTkCheckBox(
        color_row, text="Outline", font=ctk.CTkFont(size=11), text_color=COLORS.TEXT_MUTED, width=20)
    ...
    ctk.CTkLabel(color_row, text="Outline Width",
                 font=ctk.CTkFont(size=11), text_color=COLORS.TEXT_MUTED).pack(side="left", padx=(0, 6))
    ...
    w["outline_width_lbl"] = ctk.CTkLabel(
        color_row, text="3", font=ctk.CTkFont(size=11), text_color=COLORS.BRAND_PRIMARY,
        width=20, anchor="w")
